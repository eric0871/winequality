...
1. All the attributes have quite many outliers except citric.acid and alcohol. 
...
ggparcoord(red_df, columns = c(1,2,3,4,10,11), alphaLines = .3, 
           scale = "globalminmax", splineFactor = 8, groupColumn = 14)+
  ggtitle('Attributes vs Quality')
```

In this parallel coordinate plot, we group by quality into two category: poor (0-5) and good (5-10).
